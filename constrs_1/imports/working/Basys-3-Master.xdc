...
##7 segment display
set_property -dict { PACKAGE_PIN W7  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[0] }]; #IO_L13P_T2_MRCC_34 ,Sch=seg[0]
set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[1] }]; #IO_L13N_T2_MRCC_34 ,Sch=seg[1]
set_property -dict { PACKAGE_PIN U8  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[2] }]; #IO_L14P_T2_SRCC_34 ,Sch=seg[2]
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[3] }]; #IO_L14N_T2_SRCC_34 ,Sch=seg[3]
set_property -dict { PACKAGE_PIN U5  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[4] }]; #IO_L16P_T2_34      ,Sch=seg[4]
set_property -dict { PACKAGE_PIN V5  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[5] }]; #IO_L16N_T2_34      ,Sch=seg[5]
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[6] }]; #IO_L19P_T3_34      ,Sch=seg[6]
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS33 } [get_ports { fnd_data[7] }]; #IO_L19N_T3_VREF_34 ,Sch=seg[7]
